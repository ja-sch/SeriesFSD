function [A, B, Q] = my_extended_input4(n)
% Creates some matrices A, Q, B such that
% rank(A)  = 3 * n
% rank(AQB) = n
% rank(B)  = 2 * n
% Q is orthogonal
% Our decomposition is in full generality for this input (no block is trivial, i.e.
% 0-dimensional, every block that can be nonzero *is* indeed nonzero)
% 
% No matrix -- neither A nor B -- is full rank
%
% A is 4n x 5n
% B is 5n x 3n
% Q is 5n x 5n
