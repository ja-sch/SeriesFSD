classdef BlockMatrix
    % Wrapper of cell array that supports block matrix multiplication.
    ...
    methods
        ...
        function result = mtimes(obj1, obj2)
            ...
            %
            %%%% to remove?
%             % workaround, don't know how matrices can get here
%             obj2 = obj2
%             if ismatrix(obj2)
%                 % notice BlockMatrix is *not* a matrix; it is a wrapper around matrix
%                 obj2
%             end
            %%%% end of: to remove?
            % get dimensions
...
%         end
        ...
        % Analogoues of existing operators (`morally' overloading)
        ...
        function result = flat(obj)
            result = BlockMatrix({cell2mat(obj.C)});
        end
...
%         end
        ...
        % displaying BlockMatrix
        function [] = printblocks(obj)
            celldisp(obj.C)
        end
        %
        function [result] = as_readable_table_only_cols(obj)
        ...
        function result = as_readable_table(obj)
            ...
            %%% name cols
            my_table = obj.as_readable_table_only_cols();
